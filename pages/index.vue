<template>
  <Sidebar>
    <div>
      <h1 class="text-2xl font-bold border-b-2 w-fit mb-4">Troca de Cartas</h1>
      ...
      <div class="mt-6">
        ...
        <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
          <table v-if="!loading" class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
            ...
            <tbody>
              <tr v-for="trade in paginatedTrades" :key="trade.id" class="bg-gray-300 border-b hover:bg-gray-50">
                ...
                <td class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap">
                  <div class="flex justify-between items-center">
                    ...
                    <img :src="trade.tradeCards[0].card.imageUrl" alt="Card Image" class="w-8 h-full object-cover">
                  </div>
                </td>
                <td class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap">
                  <div class="flex justify-between items-center">
                    ...
                    <img :src="trade.tradeCards[1].card.imageUrl" alt="Card Image" class="w-8 h-full object-cover">
                  </div>
                </td>
...
const fetchTrades = async () => {
  try {
    loading.value = true
    const response = await fetch(`https://cards-marketplace-api.onrender.com/trades?rpp=${rpp.value}&page=${page.value}`, {
      headers: {
...
const deleteTrade = async (tradeId) => {
  try {
    ...
    // Atualizar lista de trades após deleção bem-sucedida
